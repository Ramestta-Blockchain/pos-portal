...
module.exports = async (deployer, network, accounts) => {
  deployer.then(async () => {
    ...
    await deployer.deploy(
      ChildERC1155,
      "Dummy ERC1155 on Ramestta",
      ChildChainManagerProxy.address
    );
    await deployer.deploy(
      ChildMintableERC1155,
      "Dummy Mintable ERC1155 on Ramestta",
      ChildChainManagerProxy.address
    );

    await deployer.deploy(RamaWMATIC, ChildChainManagerProxy.address);
    ...
    contractAddresses.child.RamaWMATIC = RamaWMATIC.address;
