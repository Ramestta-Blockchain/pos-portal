...
const MintableERC20PredicateProxy = artifacts.require(
...
const MintableERC721PredicateProxy = artifacts.require(
...
const MintableERC1155PredicateProxy = artifacts.require(
...
module.exports = async (deployer, network, accounts) => {
  ...
  const erc20PredicateProxy = await deployer.deploy(
    ERC20PredicateProxy,
    "0x0000000000000000000000000000000000000000"
  );
  ...
  const erc721PredicateProxy = await deployer.deploy(
  ...
  const mintableERC721Predicate = await deployer.deploy(
  ...
  const mintableErc1155Predicate = await deployer.deploy(
  ...
  await mintableErc1155PredicateProxy.updateAndCall(
    ...
    mintableErc1155Predicate.contract.methods
  ...
  const etherPredicateProxy = await deployer.deploy(
    EtherPredicateProxy,
    "0x0000000000000000000000000000000000000000"
  );
  ...
  await deployer.deploy(DummyERC20, "Dummy ERC20 on Ramestta", "DERC20");
  await deployer.deploy(
    DummyMintableERC20,
    "Dummy Mintable ERC20 on Ramestta",
    "DERC20"
  );
  // -- ends

  // -- Dummy version of ERC721
  await deployer.deploy(DummyERC721, "Dummy ERC721 on Ramestta", "DERC721");
  await deployer.deploy(
    DummyMintableERC721,
    "Dummy Mintable ERC721 on Ramestta",
    "DMERC721"
  );
  // -- ends

  // -- Dummy version of ERC1155
  await deployer.deploy(DummyERC1155, "Dummy ERC1155 on Ramestta");
  ...
  contractAddresses.root.MintableERC20Predicate =
    MintableERC20Predicate.address;
  contractAddresses.root.MintableERC20PredicateProxy =
    MintableERC20PredicateProxy.address;
  ...
  contractAddresses.root.MintableERC721Predicate =
    MintableERC721Predicate.address;
  contractAddresses.root.MintableERC721PredicateProxy =
    MintableERC721PredicateProxy.address;
  ...
  contractAddresses.root.MintableERC1155Predicate =
    MintableERC1155Predicate.address;
  contractAddresses.root.MintableERC1155PredicateProxy =
    MintableERC1155PredicateProxy.address;
