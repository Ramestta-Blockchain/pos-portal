...
async function deploy() {
  ...
  const MintableERC721Type =
    "0xd4392723c111fcb98b073fe55873efb447bcd23cd3e49ec9ea2581930cd01ddc";
  ...
  await deployer.deploy(
    tx("DummyMintableERC721", "grantRole", [
      { value: PredicateRole },
      "MintableERC721PredicateProxy",
    ])
  );
  ...
  await deployer.deploy(
    tx(
      ...
      [
        ...
        { value: contractAddresses.child.RamaWMATIC },
        { value: EtherType },
      ],
      "RootChainManagerProxy"
    )
